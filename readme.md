...
После установки перейдите к шагу [Перед началом работы](https://github.com/razsm-git/resetme?tab=readme-ov-file#%D0%BF%D0%B5%D1%80%D0%B5%D0%B4-%D0%BD%D0%B0%D1%87%D0%B0%D0%BB%D0%BE%D0%BC-%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D1%8B). Также полезными могут быть разделы [Описание конфигурационных файлов](https://github.com/razsm-git/resetme?tab=readme-ov-file#%D0%BE%D0%BF%D0%B8%D1%81%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BA%D0%BE%D0%BD%D1%84%D0%B8%D0%B3%D1%83%D1%80%D0%B0%D1%86%D0%B8%D0%BE%D0%BD%D0%BD%D1%8B%D1%85-%D1%84%D0%B0%D0%B9%D0%BB%D0%BE%D0%B2) и [Сообщения об ошибках/коды возврата](https://github.com/razsm-git/resetme?tab=readme-ov-file#%D1%81%D0%BE%D0%BE%D0%B1%D1%89%D0%B5%D0%BD%D0%B8%D1%8F-%D0%BE%D0%B1-%D0%BE%D1%88%D0%B8%D0%B1%D0%BA%D0%B0%D1%85%D0%BA%D0%BE%D0%B4%D1%8B-%D0%B2%D0%BE%D0%B7%D0%B2%D1%80%D0%B0%D1%82%D0%B0)
...
Внесите необходимые данные в файлы `secret.py` и `vars.py`. Перейдите к шагу [Перед началом работы](https://github.com/razsm-git/resetme?tab=readme-ov-file#%D0%BF%D0%B5%D1%80%D0%B5%D0%B4-%D0%BD%D0%B0%D1%87%D0%B0%D0%BB%D0%BE%D0%BC-%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D1%8B). Также полезными могут быть разделы [Описание конфигурационных файлов](https://github.com/razsm-git/resetme?tab=readme-ov-file#%D0%BE%D0%BF%D0%B8%D1%81%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BA%D0%BE%D0%BD%D1%84%D0%B8%D0%B3%D1%83%D1%80%D0%B0%D1%86%D0%B8%D0%BE%D0%BD%D0%BD%D1%8B%D1%85-%D1%84%D0%B0%D0%B9%D0%BB%D0%BE%D0%B2) и [Сообщения об ошибках/коды возврата](https://github.com/razsm-git/resetme?tab=readme-ov-file#%D1%81%D0%BE%D0%BE%D0%B1%D1%89%D0%B5%D0%BD%D0%B8%D1%8F-%D0%BE%D0%B1-%D0%BE%D1%88%D0%B8%D0%B1%D0%BA%D0%B0%D1%85%D0%BA%D0%BE%D0%B4%D1%8B-%D0%B2%D0%BE%D0%B7%D0%B2%D1%80%D0%B0%D1%82%D0%B0)
...
В репозитории есть [vars_sample.py](samples/vars_sample.py), который необходимо перенести на уровень выше и переименовать при установке вручную. В случае установки с помощью скрипта данные будут заполнены автоматически.
...
При необходимости изменить статические файлы(css, js, img ect), разместите их по пути [webapp/resetme/static](webapp/resetme/static), в соответсвующих папках, после чего необходимо выполнить команды:
```
...
2. Измените значения переменных в файле `vars.py`, учитывая ваши индивидуальные требования ([справочная информация](https://github.com/razsm-git/resetme?tab=readme-ov-file#varspy))
- Выберите цвет фона(измените значение переменных). Остальную стилизацию, если она необходима, можно делать средствами CSS, в файле [main.css](webapp/resetme/static/css/main.css) (рядом лежат файлы bootstrap)
  
3. Загрузите собственные файлы логотипов в формате `svg` в папку [webapp/resetme/static/images](webapp/resetme/static/images)
