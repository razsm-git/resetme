...
### Скрипт автоматической установки
	...
	- Перейдите к шагу `Перед началом работы`. Также полезными могут быть разделы `Описание конфигурационных файлов` и `Сообщения об ошибках/коды возврата`
...
-  ### Измените значения переменных в файле `vars.py`, учитывая ваши индивидуальные требования (справочную информацию см.выше)
...
-  ### Загрузите собственные файлы логотипов в формате `svg` в папку webapp/resetme/static/images
	...
	- logo2.svg - логотип компании в нижнем левом углу (не более чем width="200px" height="200px")
  	- выполнить команду `python3 /resetme/webapp/manage.py collectstatic` и `systemctl restart nginx`
